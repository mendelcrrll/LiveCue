...
async function getPresentationTranscript(presentationId) {
  const response = await fetch(
    `${API_BASE_URL}/api/transcription/presentations/${presentationId}/transcript`
  );
