...
module.exports.openSlidesInBrowser = (presentation) => {
  ...
  return openInBrowser(presentation.webViewLink).catch((err) => {
    console.error('Unable to open the presentation automatically:', err.message);
    console.error('Open the URL above in your browser.');
  });
}
